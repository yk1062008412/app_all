...
export default class TaroRegionPicker extends Component {
  ...
  render() {
    const { defaultRagion } = this.props
    return (
      <View>
        ...
        >
          ...
          >
            <View className='my-ragion'>
              <Text className='ragion-title'>省市区</Text>
              {
                defaultRagion ? <Text className='ragion-placeholder-check'>{defaultRagion}</Text>
                  : <Text className={this.state.region == '请选择省市区' ? 'ragion-placeholder' : 'ragion-placeholder-check'}>{this.state.region}</Text>
              }
            </View>
          </Picker>
        </View>
